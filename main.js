const excursiones = [
    ...
    {
        nombre: 'Trekking al Ojo del Albino',
        descripcion: 'Todo un reto realizar la escursión al Glaciar Ojo del Albino.',
...
const caminatas = [
    {
        nombre: 'Trekking a la Laguna Turquesa',
    ...
    {
        nombre: 'Trekking a los 5 hermanos',
